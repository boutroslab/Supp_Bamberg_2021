...
library(xtable)
comparisons=c("V1,V2_vs_DMSO1,DMSO2 neg.","V1,V2_vs_DMSO1,DMSO2 pos.");
ngenes=c(614,614);
...
\newpage\section{Comparison results of V1,V2 vs DMSO1,DMSO2 neg.}

The following figure shows the distribution of RRA score in the comparison V1,V2 vs DMSO1,DMSO2 neg., and the RRA scores of 10 genes.
...
\newpage\section{Comparison results of V1,V2 vs DMSO1,DMSO2 pos.}

The following figure shows the distribution of RRA score in the comparison V1,V2 vs DMSO1,DMSO2 pos., and the RRA scores of 10 genes.
