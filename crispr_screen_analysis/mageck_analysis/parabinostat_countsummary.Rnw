...
library(xtable)
filelist=c("/Volumes/EXTHD0214/DATA/CRISPR_Cas/Tianzuo_EHMT1_C RISPRscreens/raw_data/reads_B_P_U_screen/DMSO1_S1_ L001_R1_001.fastq.gz","/Volumes/EXTHD0214/DATA/CRISPR_Cas/Tianzuo_EHMT1_C RISPRscreens/raw_data/reads_B_P_U_screen/DMSO2_S2_ L001_R1_001.fastq.gz","/Volumes/EXTHD0214/DATA/CRISPR_Cas/Tianzuo_EHMT1_C RISPRscreens/raw_data/reads_B_P_U_screen/P1_S7_L00 1_R1_001.fastq.gz","/Volumes/EXTHD0214/DATA/CRISPR_Cas/Tianzuo_EHMT1_C RISPRscreens/raw_data/reads_B_P_U_screen/P2_S8_L00 1_R1_001.fastq.gz");
labellist=c("DMSO1","DMSO2","P1","P2");
reads=c(3363787,2826338,3357430,4117123);
mappedreads=c(2473539,2103632,2517407,3011555);
totalsgrnas=c(12434,12434,12434,12434);
zerocounts=c(76,82,63,61);
giniindex=c(0.1023051041663221,0.11753270832926965,0.09701124011512452,0.09381633577675985);
...
<<fig=TRUE,echo=FALSE,width=4.9,height=4.5>>=
genboxplot("parabinostat.count_normalized.txt");
@

The following figure shows the histogram of median-normalized read counts in all samples.


<<fig=TRUE,echo=FALSE,width=4.9,height=4.9>>=
genhistplot("parabinostat.count_normalized.txt");
@
...
<<fig=TRUE,echo=FALSE,width=6.9,height=4.9>>=
genpcaplot("parabinostat.count_normalized.txt");
@
...
<<fig=TRUE,echo=FALSE,width=4.9,height=4.9>>=
genclustering("parabinostat.count_normalized.txt");
@
