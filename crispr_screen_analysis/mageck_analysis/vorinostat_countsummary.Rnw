...
library(xtable)
filelist=c("raw_data/library_sequencing/chrom_modulators/5.0.1 .20.604/fastq_raw/2171_CRISPR_CM5_Plasmid.fastq","raw_data/reads_vorinostat_screen/2546_CRISPR_CM_DM SO1.fastq","raw_data/reads_vorinostat_screen/2547_CRISPR_CM_DM SO2.fastq","raw_data/reads_vorinostat_screen/2548_CRISPR_CM_Vo rinostat1.fastq","raw_data/reads_vorinostat_screen/2549_CRISPR_CM_Vo rinostat2.fastq");
labellist=c("LIB","DMSO1","DMSO2","V1","V2");
reads=c(4171178,1100545,1988853,2868072,3039906);
mappedreads=c(3384542,818164,1540808,2203415,2368991);
totalsgrnas=c(12434,12434,12434,12434,12434);
zerocounts=c(20,195,71,97,76);
giniindex=c(0.06032706585334946,0.1667539194052694,0.10715566253192332,0.10933894877125261,0.11071619919190057);
...
<<fig=TRUE,echo=FALSE,width=5.1,height=4.5>>=
genboxplot("vorinostat.count_normalized.txt");
@

The following figure shows the histogram of median-normalized read counts in all samples.


<<fig=TRUE,echo=FALSE,width=5.1,height=5.1>>=
genhistplot("vorinostat.count_normalized.txt");
@
...
<<fig=TRUE,echo=FALSE,width=7.1,height=5.1>>=
genpcaplot("vorinostat.count_normalized.txt");
@
...
<<fig=TRUE,echo=FALSE,width=5.1,height=5.1>>=
genclustering("vorinostat.count_normalized.txt");
@
