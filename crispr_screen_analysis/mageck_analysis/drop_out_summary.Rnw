...
library(xtable)
comparisons=c("DMSO1,DMSO2_vs_LIB neg.","DMSO1,DMSO2_vs_LIB pos.");
ngenes=c(614,614);
...
\newpage\section{Comparison results of DMSO1,DMSO2 vs LIB neg.}

The following figure shows the distribution of RRA score in the comparison DMSO1,DMSO2 vs LIB neg., and the RRA scores of 10 genes.
...
\newpage\section{Comparison results of DMSO1,DMSO2 vs LIB pos.}

The following figure shows the distribution of RRA score in the comparison DMSO1,DMSO2 vs LIB pos., and the RRA scores of 10 genes.
