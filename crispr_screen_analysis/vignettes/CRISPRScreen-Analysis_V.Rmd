...
This vignette is used to analyze a CRISPR screen performed by treating SW480 cells using 3 µM vorinostat in 0.1 % DMSO and 0.1 % DMSO as a control sample. It was screened in duplicates per treatment. Raw counts per sgRNA are the basis of the analysis.
